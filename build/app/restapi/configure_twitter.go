...
//go:generate swagger generate server --target ../../app --name Twitter --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/twitter/build/templates --principal interface{}

func configureFlags(api *operations.TwitterAPI) {
...
func configureAPI(api *operations.TwitterAPI) http.Handler {
